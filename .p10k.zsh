# Generated by Powerlevel10k configuration wizard on 2024-07-01 at 22:53 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_GIT_ICON=''  # Git icon
  ...
  function my_git_formatter() {
    ...
    local   commit_color='%87F' # cyan foreground
    local         staged='%82F' # cyan foreground
    local      untracked='%94F' # white foreground
    ...
    # [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="[${commit_color}${VCS_STATUS_COMMIT[1,8]}${clean}]"
