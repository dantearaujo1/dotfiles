...
--   runtime_one =  { name = 'JavaSE-17' , path = '/usr/lib/jvm/java-17-openjdk/' }
--   runtime_two = { name = 'JavaSE-22' , path = '/usr/lib/jvm/java-22-openjdk/' }
-- else
...
-- local path_to_jar = plugins_dir .. 'org.eclipse.equinox.launcher_1.6.800.v20240330-1250.jar'
