...
_G.packer_plugins = {
  ...
  ["dap-buddy.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/devdante/.local/share/nvim/site/pack/packer/opt/dap-buddy.nvim",
  ...
  ["nvim-window-picker"] = {
    ...
    loaded = true,
    path = "/home/devdante/.local/share/nvim/site/pack/packer/start/nvim-window-picker",
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/home/devdante/.local/share/nvim/site/pack/packer/start/vim-hexokinase",
  ...
  ["virtcolumn.nvim"] = {
    loaded = true,
    path = "/home/devdante/.local/share/nvim/site/pack/packer/start/virtcolumn.nvim",
