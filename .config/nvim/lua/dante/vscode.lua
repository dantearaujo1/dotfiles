...
keymap('n', '<localleader>f', notify 'editor.action.formatDocument', { silent = true })
...
keymap('n', '<Leader>te', notify 'workbench.action.toggleSidebarVisibility', { silent = true })
...
keymap('v', '<localleader>f', v_notify 'editor.action.formatSelection', { silent = true })
