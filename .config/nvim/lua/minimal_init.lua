...
_G.load_config = function()
  ...
  local name = 'clangd'
  local cmd = { 'clangd', '--clang-tidy', '--background-index', '--all-scopes-completion', '--header-insertion=iwyu', '--completion-style=detailed', '--log=verbose', '--query-driver=D:\\Code\\Compilers\\TDM-GCC-64\\bin\\g*', '--cross-file-rename' } -- needed for elixirls, omnisharp, sumneko_lua
  if not name then
