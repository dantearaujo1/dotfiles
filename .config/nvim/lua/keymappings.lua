...
vim.keymap.set('n', 'co', '<Plug>(diffs-conflict-ours)', { desc = "Accept ours changes" })
vim.keymap.set('n', 'ct', '<Plug>(diffs-conflict-theirs)', { desc = "Accept theis changes" })
vim.keymap.set('n', 'cb', '<Plug>(diffs-conflict-both)', { desc = "Accept both changes" })
vim.keymap.set('n', 'cn', '<Plug>(diffs-conflict-none)', { desc = "Discard both conflicted changes" })
vim.keymap.set('n', ']x', '<Plug>(diffs-conflict-next)', { desc = "Go to the next conflict" })
vim.keymap.set('n', '[x', '<Plug>(diffs-conflict-prev)', { desc = "Go to the previous conflict" })
